...
class EInvoiceSigner{
    ...
    public static function GetRequestApi($xml, $x509CertificateContent, $privateKeyContent) {
        ...
        $xslFilePath = $baseDir . '/Resources/xslfile.xsl';
        $ublTemplatePath = $baseDir . '/Resources/ZatcaDataUbl.xml'; 
        $signaturePath = $baseDir . '/Resources/ZatcaDataSignature.xml';
